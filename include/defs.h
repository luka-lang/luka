...
typedef enum
{
    LUKA_UNINITIALIZED = -1, /**< A value for the return code when the function starts */
...
extern const char *keywords[NUMBER_OF_KEYWORDS]; /**< string representations of the keywords */
...
typedef t_token *t_token_ptr; /**< A type alias for getting this type from a vector */
...
typedef struct s_ast_node t_ast_node; /**< Forward declaration for the ast node struct */
...
typedef struct
{
    ...
    unsigned int arity; /**< The arity of the function (how many arguments it takes) */
...
typedef struct
{
    ...
    t_vector *then_body; /**< The statements executed if the condition is true */
    t_vector *else_body; /**< The statements executed it the condition is false */
} t_ast_if_expr; /**< An AST node for if expressions */

typedef struct
{
    t_ast_node *cond; /**< The condition of the while expression */
    t_vector *body; /**< The statements executed as long as the condition is true */
...
{
    char *name; /**< The name of the struct */
    t_vector *struct_values; /**< The values passed to the fields in the struct */
...
typedef struct s_ast_node
{
    ...
    union
    {
        ...
        t_ast_assignment_expr assignment_expr; /**< Assignement expression AST node value */
        ...
        t_ast_expr_stmt expression_stmt; /**< Expression statement AST node value */
        t_ast_struct_definition struct_definition; /**< Struct definition AST node value */
        t_ast_struct_value struct_value; /**< Struct value AST node value */
        t_ast_enum_definition enum_definition; /**< Enum definition AST node value */
...
typedef t_ast_node *t_ast_node_ptr; /**< A type alias for getting this type from a vector */
...
typedef t_struct_field* t_struct_field_ptr; /**< A type alias for getting this type from a vector */
typedef t_struct_value_field* t_struct_value_field_ptr; /**< A type alias for getting this type from a vector */
